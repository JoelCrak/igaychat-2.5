...
<meta name="description" content="Discover <?php echo $model;?>'s cam show on <?php echo $profil['system_source_name_clean'] ;?>, a <?php echo $profil['age'] ;?> years old featured on <?php bloginfo(); ?>. Have a look at <?php echo $model;?>'s profile now!"/>
