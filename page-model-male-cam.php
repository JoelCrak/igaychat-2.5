...
/* Template Name: model-male-cam */ 

get_template_part( 'header-model-male-cam' );
    ...
    <div class="container small">
            ...
            <div class="feed_ctn">
                ...
                <div class="iframe_ctn">
                    ...
                    <a href="https://jerkmate.com/cam/<?php echo strtolower($profilcam['name']) ;?>?aff_id=3&aff_sub=CRA_999528218_IGCH_TXT&source=TS33-999528218&aff_sub2=KW_<?php echo $status ;?>_Feed&aff_sub3=Model_<?php echo $profilcam['name'] ;?>"style="position: absolute; top: 0; right: 0; bottom: 0; left: 0;"></a>
